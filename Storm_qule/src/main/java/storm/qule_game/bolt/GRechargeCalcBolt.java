...
public class GRechargeCalcBolt extends BaseBasicBolt {
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        String sql = "INSERT INTO `recharge_order_today` (`platform`, `server`,`order_id`, `status`, `uname`, `ad`, `cname`, `amount`, `yb_amnt`, `datetime`,`chid`, `chposid`, `adplanning_id`, `chunion_subid`) VALUES (" + platform + ", " + server + ", '" +order_id + "', 1, '" + uname + "', 0, '" + cname + "', " + amount + ", " + yb_amnt + "," + logtime +", "+chid+", "+chposid+","+adplanning_id+", "+chunion_subid+" );";
        if (con.add(sql)) {
