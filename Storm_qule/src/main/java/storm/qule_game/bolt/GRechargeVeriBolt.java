...
public class GRechargeVeriBolt extends BaseBasicBolt {
            ...
            if (host != null) {
                if (keywords.equals("bill")) {
                    ...
                    if (token_gen.equals(token)) {
                        collector.emit(new Values(game_abbr, platform, server, logtime,keywords,order_id,amount,uname,cname));
                    }
                }
            }
        }
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("game_abbr","platform","server","logtime","keywords","order_id","amount","uname","cname"));
    }
}