 ...
 */
public class GCurrencyPreserveCRUDcBolt extends BaseBasicBolt {
...
//        }
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        String characters = tuple.getString(4);
        Long money1 = tuple.getLong(5);
        Long money2 = tuple.getLong(6);
        Long todayDate = tuple.getLong(7);

        String ins_sql = String.format("INSERT INTO currency_preserve (platform, server, date, total_characters, yuanbao_preserve, tongqian_preserve)" +
                        " VALUES (%s, %s, %d, %s, %d, %d) ON DUPLICATE KEY UPDATE total_characters=%s, yuanbao_preserve=%d, tongqian_preserve=%d;",
                platform_id, server_id, todayDate, characters, money1, money2, characters, money1, money2);
