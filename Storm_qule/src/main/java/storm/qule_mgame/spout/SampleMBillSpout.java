 ...
 */
public class SampleMBillSpout extends BaseRichSpout {
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        InputStream in = getClass().getResourceAsStream("/msamplebilllog.txt");
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("mbill_log"));
    }
}
