 ...
 */
public class SampleMLevelupSpout extends BaseRichSpout {
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        InputStream in = getClass().getResourceAsStream("/msamplelevellog.txt");
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("mlevelup_log"));
    }
}
