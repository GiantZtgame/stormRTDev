 ...
 */
public class MLevelVeriBolt extends BaseBasicBolt {
    private static final String LOG_SIGN = "mlevel";
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        System.out.println("|||||+++++++ MLevel verify prepare!!!");
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        //GMZQ|1|1|xxxxx|1401235412|mlevel|testaccount|曼联|100|12345
        ...
        if (10 == logs.length) {
            ...
            if (token_gen.equals(token) && keywords.equals(LOG_SIGN)) {
                collector.emit(new Values(game_abbr, platform_id, server_id, datetime, uname, cname, level, costTime));
            }
        }
    }
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("game_abbr", "platform_id", "server_id", "level_datetime", "uname", "cname", "level",
                "costTime"));
    }
}
