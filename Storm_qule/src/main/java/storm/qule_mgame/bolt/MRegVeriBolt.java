 ...
 */
public class MRegVeriBolt extends BaseBasicBolt {
    private static final String LOG_SIGN = "mreg";
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        System.out.println("|||||+++++++ MReg verify prepare!!!");
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        if (18 == logs.length) {
            ...
            String uname = logs[7];
            String cname = logs[8];
            String reg_success = logs[9];
            String system = logs[10];
            String appver = logs[11];
            String model = logs[12];
            String resolution = logs[13];
            String sp = logs[14];
